document.addEventListener('DOMContentLoaded', () => {
    ...
    const addCustomUrlBtn = document.getElementById('add-custom-url-btn');
    const sidebarLinks = document.getElementById('sidebar-links');
    const selectedUrlTitle = document.getElementById('selected-url-title');
    const currentSiteDisplay = document.getElementById('current-site-display');
    const siteActionSelect = document.getElementById('site-action-select');
    const removeSiteBtn = document.getElementById('remove-site-btn');
